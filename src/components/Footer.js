                    ...
                    <div className="row pb-lg-2 my-lg-3 m-auto">
                        ...
                        <div className="col-lg-3 col-6" >
                            ...
                            <ul className="list-unstyled px-5">
                                ...
                                <li><Link className='footerLink' href="/about">About</Link></li>
                                <li><Link className='footerLink' href="/project">Project</Link></li>
                        ...
                        <div className="col-lg-3 ps-lg-5 col-6" >
                            ...
                            <ul className="list-unstyled  px-5 ">
                                ...
                                <li><Link  href='' className='footerLink' >ihiremath1991@gmail.com</Link></li>
                                <li><Link  href='' className='footerLink' >Hubballi</Link></li>
                                <li><Link  href='' className='footerLink' >Karnataka</Link></li>
